    ...
    <>
      ...
      <div className="product-section  ">
        ...
        <div className="flex flex-wrap justify-center my-5 align-center ">
          ...
          <div className="card-img w-[550px] h-[400px]  shadow-lg shadow-orange-300 mr-5 ">
            <img src={product.image} alt="laptop" className="w-full  h-full hover:translate-y-[-10px] transistion-all delay-150" />
          </div>

          <div className="card-content border-1 border-black shadow-lg shadow-black w-[550px] h-[350px] py-5 mt-5  ">
